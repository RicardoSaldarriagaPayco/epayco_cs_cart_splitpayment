{capture name="mainbox"}
    {capture name="tabsbox"}
                            ...
                            <div>
                                ...
                                <div id="step_{$index+1}_body" class="{*if !$pay}hidden{/if*} clearfix">
                                    ...
                                    <div class="ty-checkout-buttons {if !$pay}hidden{/if}">
                                        {include file="buttons/button.tpl" but_href=$script_proceed but_text=__("epayco_adaptive_pay") but_meta="btn btn-primary" but_role="action"}
                                        {if !$exist_paid}
                                            &nbsp;{include file="buttons/button.tpl" but_href=$script_cancel but_text=__("epayco_adaptive_cancel") but_meta="btn" but_role="action"}
                                        {/if}
                                    </div>
                                </div>
                            </div>
        ...
        {capture name="mainbox_title"}<span class="ty-checkout__title">{__("epayco_adaptive_progress_payment_order")}
            &nbsp;
