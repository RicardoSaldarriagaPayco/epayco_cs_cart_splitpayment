{if "MULTIVENDOR"|fn_allowed_for}
    ...
    <div class="control-group hidden">
        <label for="email" class="control-label cm-email">{__("epayco_adaptive.vendor.epayco_email")}:</label>
        <div class="controls">
            ...
            <p class="muted description">{__("ttc_epayco_adaptive.vendor.epayco_email")}</p>
        </div>
    </div>
